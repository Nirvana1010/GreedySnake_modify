...
extern int color;//表示吃到食物的颜色，=1，红色；=2，青色；=3，蓝色；=4，紫色
extern int change_color;//表示吃到某种颜色的食物后变色，=0，绿色；=1，红色；=2，青色；=3，蓝色；=4，紫色
extern int speed;//表示吃到某种颜色的食物后的速度，=0，不变；=1；加速；=2，减速
extern Obstacle o[33];
